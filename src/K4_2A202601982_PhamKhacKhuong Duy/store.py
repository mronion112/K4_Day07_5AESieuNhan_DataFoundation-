...
class EmbeddingStore:
    ...
    def _search_records(
        ...
        for rec in records:
            ...
            scored_records.append(record_res)
        ...
        if self._use_chroma and self._collection is not None:
            try:
                ...
                for meta in metadatas:
                    ...
                    cleaned_metadatas.append(cleaned if cleaned else None)
                if all(m is None for m in cleaned_metadatas):
                    chroma_metadatas = None
                else:
                    chroma_metadatas = cleaned_metadatas
    ...
    def delete_document(self, doc_id: str) -> bool:
        ...
        self._store = [
            ...
            for rec in self._store
            if rec["id"] != doc_id
            and rec.get("metadata", {}).get("doc_id") != doc_id
